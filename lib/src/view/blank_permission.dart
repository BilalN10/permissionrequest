...
class _BlankPermissionState extends State<BlankPermission> {
  ...
  @override
  void initState() {
    themeData = loadThemeData(widget.theme, widget.themeName ?? "permission", () => const PermissionThemeData())!;
    super.initState();
  }
  ...
  Widget build(BuildContext context) {
    return WillPopScope(
      ...
      child: Container(
        ...
        color: widget.backgroundColor ?? themeData.backgroundColor ?? Colors.transparent,
        child: Stack(
          children: [
            ...
            SizedBox(
              ...
              child: Column(
                ...
                children: [
                  SizedBox(height: MediaQuery.of(context).padding.top + formatHeight(20)),
                  Row(
                    mainAxisSize: MainAxisSize.max,
                    ...
                    children: [
                      if (widget.onBack != null) ...[
                        InkWell(
                          onTap: widget.onBack,
                          child: Padding(
                            padding: themeData.pagePadding ?? EdgeInsets.symmetric(horizontal: formatWidth(14)),
                            child: CTA.back(
                              onTap: widget.onBack,
                  ...
                  Expanded(
                    child: Padding(
                      padding: themeData.pagePadding ?? EdgeInsets.symmetric(horizontal: formatWidth(29)),
                      child: Column(
                        mainAxisSize: MainAxisSize.max,
                        children: [
                          Expanded(
                            child: Align(
                              ...
                              child: widget.assetChild ?? Image.asset(widget.asset!),
                            ),
                          ),
                          Expanded(
                            child: Column(
                              ...
                              children: [
                                ...
                                Text(
                                  widget.title ?? "",
                                  style: widget.titleStyle ?? themeData.titleStyle,
                                ...
                                Expanded(
                                  child: Text(
                                    widget.subtitle ?? "",
                                    style: widget.subtitleStyle ?? themeData.subTitleStyle,
                                    textAlign: TextAlign.center,
                                  ),
                                ),
                                sh(25),
                          ...
                          SizedBox(height: formatHeight(35) + MediaQuery.of(context).padding.bottom),
                        ],
                      ),
                    ),
                  ),
